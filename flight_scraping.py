...
# -----------------------------------------------
destinations = ["Bangkok","Copenhagen","Dubai","London","Madrid","Austria","Rome","Stockholm","Tokyo","Zürich","Paris"]
all_flights = []
...
csv_file_path = os.path.join(os.path.dirname(__file__), "Flights.csv")
